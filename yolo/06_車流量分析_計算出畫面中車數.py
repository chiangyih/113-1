...
# target='city.mp4'
target='https://trafficvideo.tainan.gov.tw/086adf65'
...
while 1:
    ...
    cv2.putText(frame, 'Car_count=' + str(car_count), (int(w/3),50), cv2.FONT_HERSHEY_PLAIN, 3, (0, 0, 255), 2, cv2.LINE_AA) #在畫面上顯示車輛數量
