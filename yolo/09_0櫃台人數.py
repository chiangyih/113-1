...
#區域三維陣列
area=[
    [[1017, 38],[1089, 842],[1425, 830],[1173, 34]], #區域1
    [[1427, 58],[1679, 55],[1912, 552],[1912, 812],[1818, 824],[1812, 715]], #區域2
    ]
...
def inarea(object,area):
    ...
    for i in range(len(area)):        
        ...
        overlap_percent = (intersection_area / poly1Area) * 100 #人在區域中的比例
...
while 1:
    ...
    for box in results[0].boxes.data:
        ...
        # 計算物件與區域的重疊比例    物件,區域
        ObjInArea = inarea(tempObj,area) #物件在不同區域比例陣列
        #物件在區域0的比例>=25
        #區域0 藍色
        if ObjInArea[0]>=25:
            # 自己畫外框   影像   左上角   右下角
